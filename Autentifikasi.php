...
{      public function index() 
        ...
        public function registrasi() 
    {
        ...
        //diinput akan disimpan ke dalam tabel user         if ($this->form_validation->run() == false) { 
            ...
            $this->session->set_flashdata(
                'pesan', '<div class="alert alert-success alert-message" role="alert">Selamat!! akun member anda sudah dibuat. Silahkan Aktivasi Akun anda</div>');             
            redirect('autentifikasi'); 
        } 
    } 
